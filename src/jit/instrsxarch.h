...
//    id         nm          fp  um      rf  wf  mr        mi        rm        a4        rr
INST5(invalid,   "INVALID",   0, IUM_RD,  0,  0, BAD_CODE, BAD_CODE, BAD_CODE, BAD_CODE, BAD_CODE)
INST0(align,     "align",     0, IUM_RD,  0,  0, BAD_CODE)

// These instructions are generally available and do not require a CPUID check
INST3(FIRST_BASE_INSTRUCTION, "FIRST_BASE_INSTRUCTION", 0, IUM_WR, 0, 0, BAD_CODE, BAD_CODE, BAD_CODE)

    INST4(adc,       "adc",       0, IUM_RW,  1,  1, 0x000010, 0x001080, 0x000012, 0x000014)            // Add with Carry
    INST4(add,       "add",       0, IUM_RW,  0,  1, 0x000000, 0x000080, 0x000002, 0x000004)            // Add
    INST4(and,       "and",       0, IUM_RW,  0,  1, 0x000020, 0x002080, 0x000022, 0x000024)            // Logical AND
    INST3(bt,        "bt",        0, IUM_RD,  0,  1, 0x0F00A3, BAD_CODE, 0x0F00A3)                      // Bit Test - The emitter only has partial support. It can only emit the reg,reg form and the registers need to be reversed
    INST2(call,      "call",      0, IUM_RD,  0,  1, 0x0010FF, 0x0000E8)                                // Call Procedure
    INST1(cdq,       "cdq",       0, IUM_RD,  0,  1, 0x000099)                                          // Convert Doubleword to Quadword
    INST4(cmp,       "cmp",       0, IUM_RD,  0,  1, 0x000038, 0x003880, 0x00003A, 0x00003C)            // Compare Two Operands
    INST1(cmpxchg,   "cmpxchg",   0, IUM_RW,  0,  1, 0x0F00B0)                                          // Compare and Exchange
    INST5(dec,       "dec",       0, IUM_RW,  0,  1, 0x0008FE, BAD_CODE, BAD_CODE, BAD_CODE, 0x000048)  // Decrement by 1
    INST5(dec_l,     "dec",       0, IUM_RW,  0,  1, 0x0008FE, BAD_CODE, BAD_CODE, BAD_CODE, 0x00C8FE)  //
    INST1(div,       "div",       0, IUM_RD,  0,  1, 0x0030F6)                                          // Unsigned Divide
    INST1(idiv,      "idiv",      0, IUM_RD,  0,  1, 0x0038F6)                                          // Signed Divide

    INST3(FIRST_IMUL_INSTRUCTION, "FIRST_IMUL_INSTRUCTION", 0, IUM_WR, 0, 0, BAD_CODE, BAD_CODE, BAD_CODE)

        INST3(imul,      "imul",      0, IUM_RW,  0,  1, 0x0F00AC, BAD_CODE, 0x0F00AF)                  // Signed Multiply
        INST1(imulEAX,   "imul",      0, IUM_RD,  0,  1, 0x0028F6)                                      //

        INST3(imul_AX,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x000068, BAD_CODE)                  //   Instead of encoding these as 3-operand instructions,
        INST3(imul_CX,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x000868, BAD_CODE)                  //   we encode them as 2-operand instructions with the
        INST3(imul_DX,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x001068, BAD_CODE)                  //   target register being implicit
        INST3(imul_BX,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x001868, BAD_CODE)                  //
        INST3(imul_SP,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, BAD_CODE, BAD_CODE)                  //
        INST3(imul_BP,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x002868, BAD_CODE)                  //
        INST3(imul_SI,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x003068, BAD_CODE)                  //
        INST3(imul_DI,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x003868, BAD_CODE)                  //

#ifdef _TARGET_AMD64_
        INST3(imul_08,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x4400000068, BAD_CODE)              // Signed Multiply
        INST3(imul_09,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x4400000868, BAD_CODE)              //
        INST3(imul_10,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x4400001068, BAD_CODE)              //
        INST3(imul_11,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x4400001868, BAD_CODE)              //
        INST3(imul_12,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x4400002068, BAD_CODE)              //
        INST3(imul_13,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x4400002868, BAD_CODE)              //
        INST3(imul_14,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x4400003068, BAD_CODE)              //
        INST3(imul_15,   "imul",      0, IUM_RD,  0,  1, BAD_CODE, 0x4400003868, BAD_CODE)              //
#endif // _TARGET_AMD64_

    INST3(LAST_IMUL_INSTRUCTION, "LAST_IMUL_INSTRUCTION", 0, IUM_WR, 0, 0, BAD_CODE, BAD_CODE, BAD_CODE)

    INST5(inc,       "inc",       0, IUM_RW,  0,  1, 0x0000FE, BAD_CODE, BAD_CODE, BAD_CODE, 0x000040)  // Increment by 1
    INST5(inc_l,     "inc",       0, IUM_RW,  0,  1, 0x0000FE, BAD_CODE, BAD_CODE, BAD_CODE, 0x00C0FE)  //
    INST1(int3,      "int3",      0, IUM_RD,  0,  0, 0x0000CC)                                          // Call to Interrupt Procedure 3

    INST3(FIRST_JMP_INSTRUCTION, "FIRST_JMP_INSTRUCTION", 0, IUM_WR, 0, 0, BAD_CODE, BAD_CODE, BAD_CODE)

#ifdef _TARGET_AMD64_
        INST1(rex_jmp,   "rex.jmp",   0, IUM_RD,  0,  0, 0x0020FE)                                      // Jump - Used for register indirect tail calls
#endif // _TARGET_AM

        INST1(i_jmp,     "jmp",       0, IUM_RD,  0,  0, 0x0020FE)                                      // Jump
        INST0(jmp,       "jmp",       0, IUM_RD,  0,  0, 0x0000EB)                                      // Jump
        INST0(ja,        "ja" ,       0, IUM_RD,  1,  0, 0x000077)                                      // Jump if Above
        INST0(jae,       "jae",       0, IUM_RD,  1,  0, 0x000073)                                      // Jump if Above or Equal
        INST0(jb,        "jb",        0, IUM_RD,  1,  0, 0x000072)                                      // Jump if Below
        INST0(jbe,       "jbe",       0, IUM_RD,  1,  0, 0x000076)                                      // Jump if Below or Equal
        INST0(je,        "je",        0, IUM_RD,  1,  0, 0x000074)                                      // Jump if Equal
        INST0(jg,        "jg",        0, IUM_RD,  1,  0, 0x00007F)                                      // Jump if Greater
        INST0(jge,       "jge",       0, IUM_RD,  1,  0, 0x00007D)                                      // Jump if Greater or Equal
        INST0(jl,        "jl",        0, IUM_RD,  1,  0, 0x00007C)                                      // Jump if Less
        INST0(jle,       "jle",       0, IUM_RD,  1,  0, 0x00007E)                                      // Jump if Less or Equal
        INST0(jne,       "jne",       0, IUM_RD,  1,  0, 0x000075)                                      // Jump if Not Equal
        INST0(jno,       "jno",       0, IUM_RD,  1,  0, 0x000071)                                      // Jump if Not Overflow
        INST0(jns,       "jns",       0, IUM_RD,  1,  0, 0x000079)                                      // Jump if Not Sign
        INST0(jo,        "jo",        0, IUM_RD,  1,  0, 0x000070)                                      // Jump if Overflow
        INST0(jpe,       "jpe",       0, IUM_RD,  1,  0, 0x00007A)                                      // Jump if Parity Even
        INST0(jpo,       "jpo",       0, IUM_RD,  1,  0, 0x00007B)                                      // Jump if Parity Odd
        INST0(js,        "js",        0, IUM_RD,  1,  0, 0x000078)                                      // Jump if Sign

        INST0(l_jmp,     "jmp",       0, IUM_RD,  0,  0, 0x0000E9)                                      // Jump
        INST0(l_ja,      "ja",        0, IUM_RD,  1,  0, 0x00870F)                                      // Jump if Above
        INST0(l_jae,     "jae",       0, IUM_RD,  1,  0, 0x00830F)                                      // Jump if Above or Equal
        INST0(l_jb,      "jb",        0, IUM_RD,  1,  0, 0x00820F)                                      // Jump if Below
        INST0(l_jbe,     "jbe",       0, IUM_RD,  1,  0, 0x00860F)                                      // Jump if Below or Equal
        INST0(l_je,      "je",        0, IUM_RD,  1,  0, 0x00840F)                                      // Jump if Equal
        INST0(l_jg,      "jg",        0, IUM_RD,  1,  0, 0x008F0F)                                      // Jump if Greater
        INST0(l_jge,     "jge",       0, IUM_RD,  1,  0, 0x008D0F)                                      // Jump if Greater or Equal
        INST0(l_jl,      "jl",        0, IUM_RD,  1,  0, 0x008C0F)                                      // Jump if Less
        INST0(l_jle,     "jle",       0, IUM_RD,  1,  0, 0x008E0F)                                      // Jump if Less or Equal
        INST0(l_jne,     "jne",       0, IUM_RD,  1,  0, 0x00850F)                                      // Jump if Not Equal
        INST0(l_jno,     "jno",       0, IUM_RD,  1,  0, 0x00810F)                                      // Jump if Not Overflow
        INST0(l_jns,     "jns",       0, IUM_RD,  1,  0, 0x00890F)                                      // Jump if Not Sign
        INST0(l_jo,      "jo",        0, IUM_RD,  1,  0, 0x00800F)                                      // Jump if Overflow
        INST0(l_jpe,     "jpe",       0, IUM_RD,  1,  0, 0x008A0F)                                      // Jump if Parity Even
        INST0(l_jpo,     "jpo",       0, IUM_RD,  1,  0, 0x008B0F)                                      // Jump if Parity Odd
        INST0(l_js,      "js",        0, IUM_RD,  1,  0, 0x00880F)                                      // Jump if Sign

    INST3(LAST_JMP_INSTRUCTION, "LAST_JMP_INSTRUCTION", 0, IUM_WR, 0, 0, BAD_CODE, BAD_CODE, BAD_CODE)

    INST4(lea,       "lea",       0, IUM_WR,  0,  0, BAD_CODE, BAD_CODE, 0x00008D, BAD_CODE)            // Load Effective Address
    INST1(leave,     "leave",     0, IUM_RD,  0,  0, 0x0000C9)                                          // High Level Procedure Exit
    INST1(lock,      "lock",      0, IUM_RD,  0,  0, 0x0000F0)                                          // Assert LOCK# Signal Prefix
    INST2(loop,      "loop",      0, IUM_RD,  0,  0, BAD_CODE, 0x0000E2)                                // Loop According to ECX Counter
    INST4(mov,       "mov",       0, IUM_WR,  0,  0, 0x000088, 0x0000C6, 0x00008A, 0x0000B0)            // Move
    INST1(movsb,     "movsb",     0, IUM_RD,  0,  0, 0x0000A4)                                          // Move Data from String to String
    INST1(movsd,     "movsd",     0, IUM_RD,  0,  0, 0x0000A5)                                          //

#if defined(_TARGET_AMD64_) && !defined(LEGACY_BACKEND)
    INST1(movsq,     "movsq",     0, IUM_RD,  0,  0, 0x00A548)                                          // Move Data from String to String
#endif // _TARGET_AMD64_ && !LEGACY_BACKEND

    INST3(movsx,     "movsx",     0, IUM_WR,  0,  0, BAD_CODE, BAD_CODE, 0x0F00BE)                      // Move with Sign-Extension

#ifdef _TARGET_AMD64_
    INST3(movsxd,    "movsxd",    0, IUM_WR,  0,  0, BAD_CODE, BAD_CODE,     0x4800000063LL)            // Move with Sign-Extension
#endif // _TARGET_AMD64_

    INST3(movzx,     "movzx",     0, IUM_WR,  0,  0, BAD_CODE, BAD_CODE, 0x0F00B6)                      // Move with Zero-Extend
    INST1(mulEAX,    "mul",       0, IUM_RD,  0,  1, 0x0020F6)                                          // Unsigned Multiply
    INST1(neg,       "neg",       0, IUM_RW,  0,  1, 0x0018F6)                                          // Two's Complement Negation
    INST1(nop,       "nop",       0, IUM_RD,  0,  0, 0x000090)                                          // No Operation
    INST1(not,       "not",       0, IUM_RW,  0,  1, 0x0010F6)                                          // One's Complement Negation
    INST4(or,        "or",        0, IUM_RW,  0,  1, 0x000008, 0x000880, 0x00000A, 0x00000C)            // Logical OR
    INST5(pop,       "pop",       0, IUM_WR,  0,  0, 0x00008E, BAD_CODE, BAD_CODE, BAD_CODE, 0x000058)  // Pop a Value from the Stack
    INST5(pop_hide,  "pop",       0, IUM_WR,  0,  0, 0x00008E, BAD_CODE, BAD_CODE, BAD_CODE, 0x000058)  //   Does not affect the stack tracking in the emitter
    INST5(push,      "push",      0, IUM_RD,  0,  0, 0x0030FE, 0x000068, BAD_CODE, BAD_CODE, 0x000050)  // Push Word, Doubleword or Quadword Onto the Stack
    INST5(push_hide, "push",      0, IUM_RD,  0,  0, 0x0030FE, 0x000068, BAD_CODE, BAD_CODE, 0x000050)  //   Does not affect the stack tracking in the emitter
    INST1(r_movsb,   "rep movsb", 0, IUM_RD,  0,  0, 0x00A4F3)                                          // Repeat Move Data from String to String
    INST1(r_movsd,   "rep movsd", 0, IUM_RD,  0,  0, 0x00A5F3)                                          //

#if defined(_TARGET_AMD64_) && !defined(LEGACY_BACKEND)
    INST1(r_movsq,   "rep movsq", 0, IUM_RD,  0,  0, 0xF3A548)                                          // Repeat Move Data from String to String
#endif // _TARGET_AMD64_ && !LEGACY_BACKEND

    INST1(r_stosb,   "rep stosb", 0, IUM_RD,  0,  0, 0x00AAF3)                                          // Repeat Store String
    INST1(r_stosd,   "rep stosd", 0, IUM_RD,  0,  0, 0x00ABF3)                                          //

#if defined(_TARGET_AMD64_) && !defined(LEGACY_BACKEND)
    INST1(r_stosq,   "rep stosq", 0, IUM_RD,  0,  0, 0xF3AB48)                                          // Repeat Store String
#endif // _TARGET_AMD64_ && !LEGACY_BACKEND

    INST2(rcl,       "rcl",       0, IUM_RW,  1,  1, 0x0010D2, BAD_CODE)                                // Rotate through Carry Left
    INST2(rcl_1,     "rcl",       0, IUM_RW,  1,  1, 0x0010D0, 0x0010D0)                                //
    INST2(rcl_N,     "rcl",       0, IUM_RW,  1,  1, 0x0010C0, 0x0010C0)                                //
    INST2(rcr,       "rcr",       0, IUM_RW,  1,  1, 0x0018D2, BAD_CODE)                                // Rotate through Carry Right
    INST2(rcr_1,     "rcr",       0, IUM_RW,  1,  1, 0x0018D0, 0x0018D0)                                //
    INST2(rcr_N,     "rcr",       0, IUM_RW,  1,  1, 0x0018C0, 0x0018C0)                                //
    INST2(ret,       "ret",       0, IUM_RD,  0,  0, 0x0000C3, 0x0000C2)                                // Return from Procedure
    INST2(rol,       "rol",       0, IUM_RW,  0,  1, 0x0000D2, BAD_CODE)                                // Rotate Left
    INST2(rol_1,     "rol",       0, IUM_RW,  0,  1, 0x0000D0, 0x0000D0)                                //
    INST2(rol_N,     "rol",       0, IUM_RW,  0,  1, 0x0000C0, 0x0000C0)                                //
    INST2(ror,       "ror",       0, IUM_RW,  0,  1, 0x0008D2, BAD_CODE)                                // Rotate Right
    INST2(ror_1,     "ror",       0, IUM_RW,  0,  1, 0x0008D0, 0x0008D0)                                //
    INST2(ror_N,     "ror",       0, IUM_RW,  0,  1, 0x0008C0, 0x0008C0)                                //
    INST1(sahf,      "sahf",      0, IUM_RD,  0,  1, 0x00009E)                                          // Store AH into Flags
    INST2(sar,       "sar",       0, IUM_RW,  0,  1, 0x0038D2, BAD_CODE)                                // Shift Arithmetic Right
    INST2(sar_1,     "sar",       0, IUM_RW,  0,  1, 0x0038D0, 0x0038D0)                                //
    INST2(sar_N,     "sar",       0, IUM_RW,  0,  1, 0x0038C0, 0x0038C0)                                //
    INST4(sbb,       "sbb",       0, IUM_RW,  1,  1, 0x000018, 0x001880, 0x00001A, 0x00001C)            // Integer Subtraction with Borrow

    INST3(FIRST_CSET_INSTRUCTION, "FIRST_CSET_INSTRUCTION", 0, IUM_WR, 0, 0, BAD_CODE, BAD_CODE, BAD_CODE)

        INST1(seta,      "seta",      0, IUM_WR,  1,  0, 0x0F0097)                                      // Set Byte if Above
        INST1(setae,     "setae",     0, IUM_WR,  1,  0, 0x0F0093)                                      // Set Byte if Above or Equal
        INST1(setb,      "setb",      0, IUM_WR,  1,  0, 0x0F0092)                                      // Set Byte if Below
        INST1(setbe,     "setbe",     0, IUM_WR,  1,  0, 0x0F0096)                                      // Set Byte if Below or Equal
        INST1(sete,      "sete",      0, IUM_WR,  1,  0, 0x0F0094)                                      // Set Byte if Equal
        INST1(setg,      "setg",      0, IUM_WR,  1,  0, 0x0F009F)                                      // Set Byte if Greater
        INST1(setge,     "setge",     0, IUM_WR,  1,  0, 0x0F009D)                                      // Set Byte if Greater or Equal
        INST1(setl,      "setl",      0, IUM_WR,  1,  0, 0x0F009C)                                      // Set Byte if Less
        INST1(setle,     "setle",     0, IUM_WR,  1,  0, 0x0F009E)                                      // Set Byte if Less or Equal
        INST1(setne,     "setne",     0, IUM_WR,  1,  0, 0x0F0095)                                      // Set Byte if Not Equal
        INST1(setno,     "setno",     0, IUM_WR,  1,  0, 0x0F0091)                                      // Set Byte if Not Overflow
        INST1(setns,     "setns",     0, IUM_WR,  1,  0, 0x0F0099)                                      // Set Byte if Not Sign
        INST1(seto,      "seto",      0, IUM_WR,  1,  0, 0x0F0090)                                      // Set Byte if Overflow
        INST1(setpe,     "setpe",     0, IUM_WR,  1,  0, 0x0F009A)                                      // Set Byte if Parity Even
        INST1(setpo,     "setpo",     0, IUM_WR,  1,  0, 0x0F009B)                                      // Set Byte if Parity Odd
        INST1(sets,      "sets",      0, IUM_WR,  1,  0, 0x0F0098)                                      // Set Byte if Sign

    INST3(LAST_CSET_INSTRUCTION, "LAST_CSET_INSTRUCTION", 0, IUM_WR, 0, 0, BAD_CODE, BAD_CODE, BAD_CODE)

    INST2(shl,       "shl",       0, IUM_RW,  0,  1, 0x0020D2, BAD_CODE)                                // Shift Left
    INST2(shl_1,     "shl",       0, IUM_RW,  0,  1, 0x0020D0, 0x0020D0)                                //
    INST2(shl_N,     "shl",       0, IUM_RW,  0,  1, 0x0020C0, 0x0020C0)                                //
    INST1(shld,      "shld",      0, IUM_RW,  0,  1, 0x0F00A4)                                          // Double Precision Shift Left
    INST2(shr,       "shr",       0, IUM_RW,  0,  1, 0x0028D2, BAD_CODE)                                // Shift Right
    INST2(shr_1,     "shr",       0, IUM_RW,  0,  1, 0x0028D0, 0x0028D0)                                //
    INST2(shr_N,     "shr",       0, IUM_RW,  0,  1, 0x0028C0, 0x0028C0)                                //
    INST1(shrd,      "shrd",      0, IUM_RW,  0,  1, 0x0F00AC)                                          // Double Precision Shift Right
    INST1(stosb,     "stosb",     0, IUM_RD,  0,  0, 0x0000AA)                                          // Store String
    INST1(stosd,     "stosd",     0, IUM_RD,  0,  0, 0x0000AB)                                          //

#if defined(_TARGET_AMD64_) && !defined(LEGACY_BACKEND)
    INST1(stosq,     "stosq",     0, IUM_RD,  0,  0, 0x00AB48)                                          // Store String
#endif // _TARGET_AMD64_ && !LEGACY_BACKEND

    INST4(sub,       "sub",       0, IUM_RW,  0,  1, 0x000028, 0x002880, 0x00002A, 0x00002C)            // Subtract
    INST4(test,      "test",      0, IUM_RD,  0,  1, 0x000084, 0x0000F6, 0x000084, 0x0000A8)            // Logical Compare
    INST1(xadd,      "xadd",      0, IUM_RW,  0,  1, 0x0F00C0)                                          // Exchange and Add
    INST3(xchg,      "xchg",      0, IUM_RW,  0,  0, 0x000086, BAD_CODE, 0x000086)                      // Exchange Register/Memory with Register
    INST4(xor,       "xor",       0, IUM_RW,  0,  1, 0x000030, 0x003080, 0x000032, 0x000034)            // Logical XOR

INST3(LAST_BASE_INSTRUCTION, "LAST_BASE_INSTRUCTION", 0, IUM_WR, 0, 0, BAD_CODE, BAD_CODE, BAD_CODE)

// These instructions require CPUID:80000001, EDX:CMOV
INST3(FIRST_CMOV_INSTRUCTION, "FIRST_CMOV_INSTRUCTION", 0, IUM_WR, 0, 0, BAD_CODE, BAD_CODE, BAD_CODE)

    INST3(cmova,     "cmova",     0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F0047)                      // Move if Above 
    INST3(cmovae,    "cmovae",    0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F0043)                      // Move if Above or Equal 
    INST3(cmovb,     "cmovb",     0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F0042)                      // Move if Below 
    INST3(cmovbe,    "cmovbe",    0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F0046)                      // Move if Below or Equal 
    INST3(cmove,     "cmove",     0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F0044)                      // Move if Equal 
    INST3(cmovg,     "cmovg",     0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F004F)                      // Move if Greater 
    INST3(cmovge,    "cmovge",    0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F004D)                      // Move if Greater or Equal 
    INST3(cmovl,     "cmovl",     0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F004C)                      // Move if Less 
    INST3(cmovle,    "cmovle",    0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F004E)                      // Move if Less or Equal 
    INST3(cmovne,    "cmovne",    0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F0045)                      // Move if Not Equal 
    INST3(cmovno,    "cmovno",    0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F0041)                      // Move if Not Overflow 
    INST3(cmovns,    "cmovns",    0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F0049)                      // Move if Not Sign 
    INST3(cmovo,     "cmovo",     0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F0040)                      // Move if Overflow 
    INST3(cmovpe,    "cmovpe",    0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F004A)                      // Move if Parity Even 
    INST3(cmovpo,    "cmovpo",    0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F004B)                      // Move if Parity Odd 
    INST3(cmovs,     "cmovs",     0, IUM_WR,  1,  0, BAD_CODE, BAD_CODE, 0x0F0048)                      // Move if Sign 

INST3(LAST_CMOV_INSTRUCTION, "LAST_CMOV_INSTRUCTION", 0, IUM_WR, 0, 0, BAD_CODE, BAD_CODE, BAD_CODE)
